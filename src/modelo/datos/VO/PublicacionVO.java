...
public class PublicacionVO {
	 ...
	 */
	public PublicacionVO(int id_publicacion, String usuario, LocalDate fecha, boolean spoiler, int juego, String texto,
			int reports) {
		super();
	 ...
	 * @param texto
	 * 
	 *            Construye el objeto PublicacionVO con el paremtro spoiler por
	 *            defecto
	 */
	public PublicacionVO(int id_publicacion, String usuario, LocalDate fecha, int juego, String texto) {
		this(id_publicacion, usuario, fecha, false, juego, texto, 0);
	}
